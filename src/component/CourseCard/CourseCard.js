  ...
  return (
    <div className="hold">
      ...
      <div className="detail">
        ...
        <p className="name">Samay Jain,Ex-LPMG</p>
        <div>
          <span className="ratingspan">4.0</span>
          <Rating size={20} initialValue={4} />
        </div>
        <a href="#" className="enrollnow">ENROLL</a>
      </div>
    </div>
  );
};
